...
/***/ "./src/js/globalVariable.js":
/*!**********************************!*\
  !*** ./src/js/globalVariable.js ***!
  \**********************************/
/*! exports provided: login, userMail, modifyGeoLocatorON, modifyUserMail, returnUserMail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"login\", function() { return login; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"userMail\", function() { return userMail; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"modifyGeoLocatorON\", function() { return modifyGeoLocatorON; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"modifyUserMail\", function() { return modifyUserMail; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"returnUserMail\", function() { return returnUserMail; });\nlet login = 'none';\nlet userMail = '';\ndocument.getElementById('user').style.display = login;\n\nfunction modifyGeoLocatorON( value ) { geoLocatorON = value; }\n\nfunction modifyUserMail(value) {\n    if(value === 'none') {\n        userMail = '';\n        login = 'none';\n    }\n    else {\n        userMail = value.user.email;\n        login = 'inline';\n        // console.log('login');\n        // console.log(login);\n    }\n    document.getElementById('user').style.display = login;\n    var t = document.createTextNode(`${userMail}`);\n    document.getElementById('user').appendChild(document.createElement('span').appendChild(t));\n}\n\nfunction returnUserMail() {\n    return userMail;\n}\n\n//# sourceURL=webpack:///./src/js/globalVariable.js?");
